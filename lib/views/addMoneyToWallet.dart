...
import 'package:astromeetCustomer/model/businessLayer/baseRoute.dart';
                      ...
                      GetBuilder<WalletController>(builder: (c) {
                        return GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              print("cashbackprice");
                              print(
                                  "${walletController.paymentAmount[index].cashback}");
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                "Get ${walletController.paymentAmount[index].cashback}% Extra",
                                                style: TextStyle(
                                                  fontSize: 13,
                                                  color: Colors.white,
                                                  fontWeight: FontWeight.w600,
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      ...
                                      children: [
                                        ...
                                        // index.isOdd?SizedBox():
                                        walletController.paymentAmount[index]
                                                    .cashback ==
                                                0
                                            ? SizedBox()
                                            : Expanded(
