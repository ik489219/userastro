                      ...
                      return SizedBox(
                        ...
                        child: BottomNavigationBar(
                          ...
                          items: List.generate(iconList.length, (index) {
                            if (index == 0) {
                              if (bottomNavigationController.isValueShow ==
                                  false) {
                              ...
                              if (bottomNavigationController.isValueShowChat ==
                                  false) {
                                bottomNavigationController.isValueShowChat =
                                    true;
                              }
                              return BottomNavigationBarItem(
                                icon: Icon(
                              ...
                              if (bottomNavigationController.isValueShowLive ==
                                  false) {
                                bottomNavigationController.isValueShowLive =
                                    true;
                              }
                              return BottomNavigationBarItem(
                              ...
                              if (bottomNavigationController.isValueShowCall ==
                                  false) {
                                bottomNavigationController.isValueShowCall =
                                    true;
                              }
                              return BottomNavigationBarItem(
                                activeIcon: Icon(
                              ...
                              if (bottomNavigationController.isValueShowHist ==
                                  false) {
                                bottomNavigationController.isValueShowHist =
                                    true;
                              }
                              return BottomNavigationBarItem(
                                activeIcon: Icon(
                          ...
                          onTap: (index) async {
                            if (index == 0) {
                              ...
                              bottomNavigationController.setBottomIndex(index,
