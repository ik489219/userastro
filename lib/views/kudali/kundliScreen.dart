...
import 'package:astromeetCustomer/views/kudali/createNewKundli.dart';
import 'package:astromeetCustomer/views/kudali/editKundliScreen.dart';
import 'package:astromeetCustomer/views/kudali/kundliDetailsScreen.dart';
                    ...
                    GetBuilder<KundliController>(builder: (kundliController) {
                      return kundliController.searchKundliList.length == 0
                          ...
                          : ListView.builder(
                              ...
                              itemCount:
                                  kundliController.searchKundliList.length,
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () async {
                                    global.showOnlyLoaderDialog(context);
                                    kundliController
                                        .pdfKundali(kundliController
