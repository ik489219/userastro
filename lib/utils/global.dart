...
String baseUrl = "https://theastromeet.com/api";
String imgBaseurl = "https://theastromeet.com/";
String webBaseUrl = "https://theastromeet.com/api/";
String appMode = "LIVE";
Map<String, dynamic> appParameters = {
  "LIVE": {
    "apiUrl": "https://theastromeet.com/api",
    "imageBaseurl": "https://theastromeet.com/",
  },
  "DEV": {
    "apiUrl": "http://13.203.110.227/api",
    "imageBaseurl": "http://13.203.110.227/",
  }
};
String agoraChannelName = ""; //valid 24hr
String agoraToken = "";
String channelName = "astromeetLive";
String agoraLiveToken = "";
String liveChannelName = "astromeetLive";
String agoraChatUserId = "astromeetLive";
String chatChannelName = "astromeetLive";
