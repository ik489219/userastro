...
import 'package:astromeetCustomer/model/astrologer_availability_model.dart';
...
import 'package:astromeetCustomer/model/counsellor_model.dart';
...
import 'package:astromeetCustomer/model/dailyHoroscope_model.dart';
...
import 'package:astromeetCustomer/model/language.dart';
...
import 'package:astromeetCustomer/model/live_user_model.dart';
import 'package:astromeetCustomer/model/notifications_model.dart';
import 'package:astromeetCustomer/model/remote_host_model.dart';
...
import 'package:astromeetCustomer/model/wait_list_model.dart';
import 'package:astromeetCustomer/utils/global.dart';
import 'package:astromeetCustomer/utils/services/api_result.dart';
...
//add API
  Future<dynamic> addKundli(
    ...
    try {
      ...
      log("matching code ${response.statusCode}");
      log("matching response ${response.body}");
...
//=------------------------------chat----------------->
  ...
  Future<dynamic> getResourceId(String cname, String? uid) async {
    try {
      final response = await http.post(
        Uri.parse(
  ...
  Future<dynamic> agoraStopCloudRecording(String cname, String uid) async {
