  ...
  Future<void> createLiveAstrologerShareLink(
    ...
    try {
      await FlutterShare.share(
        title: 'Watch $astrologerName live on Astro Meet app now - ',
        text: 'Watch $astrologerName live on Astro Meet app now - ',
        linkUrl: '$appShareLinkForLiveSreaming',
        chooserTitle: 'Watch $astrologerName live on Astro Meet app now - ',
      );
    } catch (e) {
